...
# 
# I used SelectKBest on features and selected the 9, 10 and 11 best features.
...
# For k=9 I get an accuarcy of 79%, a precision of 23%, a recall of 60% and a f1 score of 33%.
...
# For k=11 I get an accuarcy of 81.25%, a precision of 23%, a recall of 60% and a f1 score of 33%.
...
# For k=10 we get an accuarcy of 83.3%, a precision of 30%, a recall of 60% and a f1 score of 40%.
# Since this gets the best result I decided to continue with the 10 best features.
...
# 
# In the following I used a decision tree classifier.
# 
# I first started with the default parameters and got an accuracy score of 85.4% after 0.003s. I got a recall score of 60% and a precision score of 23%. Additionally, I got an f1 score of 33%.
# 
# I used SelectKBest on features and selected the 9, 10 and 11 best features. For k=10 I got the best results with an accuarcy of 83.3%, a precision of 30%, a recall of 60% and a f1 score of 40%.
# 
# Since this gets the best result I decided to continue with the 10 best features and ranked them according to their importance.
...
# 
# 
# My model achieved an overall accuracy score of 81.25%, a precision score of 88% and a recall score of 81%. Additionally, the model has an f1 score of 84%. The classifier beats the 30% for precision and recall.
# 
# 
# ### Interpretation
